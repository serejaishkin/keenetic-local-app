...
- [ ] SSH-терминал (полноценный интерактивный, сейчас только reboot через SSH)
- [ ] Резервная копия: пока только статус, нужно создание/восстановление/скачивание конфига
- [ ] Включение/выключение LAN-портов (ждёт проверки RCI на живом железе)
- [ ] WPS PIN-ввод, тонкие настройки mesh (MWS)
- [ ] Установка и управление компонентами SMB/DLNA прямо из раздела «Сетевые сервисы»
